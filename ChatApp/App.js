...
export default class App extends Component {
  ...
  componentDidMount(){
    ...
    this.socket.on("User_Name", name =>{
        ...
        this.socket.emit("debug2", this.state.Prev_name);
    });
...
//            this.setState({ names: [...this.state.names, this.state.Prev_name]});
...
//            }
  ...
  submitChatMessage(){
    ...
    this.socket.emit("debug1", this.state._state);
...
//    this.setState({name:""});
  ...
  submitName(){
    ...
    this.socket.emit("debug1", this.state.value);
    this.setState({chatMessage:""});
  }
